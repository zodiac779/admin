...
if(isset($_POST['data-id']) and isset($_POST['state'])){
    ...
    $query_rs_update = "UPDATE languages SET `languages`.`status` = ".$_POST['state']." WHERE `languages`.`id` = ".$_POST['data-id'];
    $rs_update = mysql_query($query_rs_update, $conn_database) or die(mysql_error());
    exit();
}

mysql_select_db($database_conn_database, $conn_database);
$query_rs_index = "SELECT * FROM languages ORDER BY rank DESC";
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_1" data-rankDarg>
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="no-sort" ><center><strong>Abbreviation</strong></center></th>
                                        ...
                                        <tbody>
                                            <?php if($totalRows_rs_index > 0){
                                                ...
                                                <tr data-id="<?php echo $row_rs_index['id']; ?>" data-rank="<?php echo $row_rs_index['rank']; ?>">
                                                    ...
                                                    <td align="center"><?php echo $row_rs_index['lang_name']; ?></td>
                                                    <td align="center"><?php echo $row_rs_index['lang_abbr']; ?></td>
