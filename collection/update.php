                                        ...
                                        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){ 
                                          ...
                                          do{
                                            ...
                                            $query_rs_update_locali = sprintf("SELECT * FROM collection_localization li  WHERE li.lang_id = %d AND li.collection_id = %d",GetSQLValueString($row_rs_lang['id'],'int'),GetSQLValueString($row_rs_update['id'],'int'));
                                             $rs_update_locali = mysqli_query(conn_database(),$query_rs_update_locali) or die(mysql_error());
                                             $row_rs_update_locali = mysqli_fetch_assoc($rs_update_locali);
                                             $totalRows_rs_update_locali = mysqli_num_rows($rs_update_locali);
                                             if($totalRows_rs_update_locali==0){
                                                ...
                                                mysqli_query(conn_database(),$query_add_locali) or die(mysql_error());
                                              }
                                              $counter++;
