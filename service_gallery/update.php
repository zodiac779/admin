                                            ...
                                            <div class="light">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        $rs_service_gallery = mysqli_query(conn_database(),$query_rs_service_gallery) or die(mysql_error());
                                                        $row_rs_service_gallery = mysqli_fetch_assoc($rs_service_gallery);
                                                        $totalRows_rs_service_gallery = mysqli_num_rows($rs_service_gallery);
                                                        if($totalRows_rs_service_gallery==0){
                                                          ...
                                                          mysqli_query(conn_database(),$query_add_service_gallery) or die(mysql_error());
                                                        }
                                                        $counter++;
