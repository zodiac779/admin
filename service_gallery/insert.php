...
mysql_select_db($database_conn_database, $conn_database);
$query_rs_insert = sprintf("SELECT * FROM service_localization INNER JOIN languages ON languages.id = service_localization.lang_id WHERE service_id  = %d ORDER BY languages.rank DESC LIMIT 1", GetSQLValueString($colname_rs_insert, "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "service_gallery")) {
    ...
    if($checker1){
        ...
        mysql_select_db($database_conn_database, $conn_database);
        $query_rs_insert = "SELECT rank FROM service_gallery WHERE service_id = ".$_POST['service_id']." ORDER BY rank DESC LIMIT 1";
        $rs_insert = mysql_query($query_rs_insert, $conn_database) or die(mysql_error());
        $row_rs_insert = mysql_fetch_assoc($rs_insert);

        $new_rank = $row_rs_insert['rank']+1;

        $insertSQL = sprintf("INSERT INTO service_gallery (service_id, image1, alt1, status, rank) VALUES (%s, %s, %s, %s, %s)",
        ...
        while ($row_rs_lang = mysql_fetch_assoc($rs_lang)){
            $insertSQL = sprintf("INSERT INTO service_gallery_localization (title1, service_gallery_id, lang_id) VALUES(%s, %d, %d) ",
        ...
        if(isset($_POST['insert_more']))
            $insertGoTo = "insert.php?id=".$colname_rs_insert['service_id'];
        else
                            ...
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="service_gallery" id="service_gallery" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Service Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 600 x 450 px</span> <span style="font-size:14px; color:#F00;">*</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" require onchange="imageSelectHandler(this);" data-width="600" data-height="450">
                                                                            </span>
                                                        ...
                                                        <div class="tab-pane fade" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Service Gallery Title</label> <span style="font-size:14px; color:#F00;">*</span>
                                    ...
                                    <div class="form-actions right">
                                        <a href="index.php?id=<?php echo $row_rs_insert['service_id']; ?>" class="btn btn-outline dark" >Back</a>
                                    ...
                                    <input type="hidden" name="MM_insert" value="service_gallery">
                                    <input type="hidden" name="service_id" value="<?php echo $colname_rs_insert; ?>">
                                </form>
                                <script>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            $('#service_gallery').on('submit', function(){
                var reposn = true;
                $('#service_gallery').find('input[require]').each(function(){
                    if($(this).val() == ""){
