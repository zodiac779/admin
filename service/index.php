...
if(isset($_POST['data-id']) and isset($_POST['state_showhome'])){
    ...
    $query_rs_update = "UPDATE service SET service.".$_POST['data-mode']." = ".$_POST['state_showhome']." WHERE service.id = ".$_POST['data-id'];
...
if(isset($_POST['data-id']) and isset($_POST['state_related'])){
    mysql_select_db($database_conn_database, $conn_database);
    $query_rs_update = "UPDATE service SET service.".$_POST['data-mode']." = ".$_POST['state_related']." WHERE service.id = ".$_POST['data-id'];
    $rs_update = mysql_query($query_rs_update, $conn_database) or die(mysql_error());
    exit();
}
...
if(isset($_POST['data-id']) and isset($_POST['state_status'])){
    mysql_select_db($database_conn_database, $conn_database);
    $query_rs_update = "UPDATE service SET service.".$_POST['data-mode']." = ".$_POST['state_status']." WHERE service.id = ".$_POST['data-id'];
    $rs_update = mysql_query($query_rs_update, $conn_database) or die(mysql_error());
    exit();
}
...
mysql_select_db($database_conn_database, $conn_database);
$query_rs_index = "SELECT * FROM service ORDER BY rank DESC";
                                            ...
                                            <?php if($totalRows_rs_index > 0){
                                                ...
                                                <tr data-id="<?php echo $row_rs_index['id']; ?>" data-rank="<?php echo $row_rs_index['rank']; ?>">
                                                    ...
                                                    while ($row_rs_lang = mysql_fetch_assoc($rs_lang)){
                                                        mysql_select_db($database_conn_database, $conn_database);
                                                        $query_rs_service = sprintf("SELECT * FROM service_localization sl WHERE sl.lang_id = %d AND sl.service_id = %d", GetSQLValueString($row_rs_lang['id'],'int'),GetSQLValueString($row_rs_index['id'],'int'));
                                                    ...
                                                    ?>
                                                    <td style="vertical-align:middle;"><?php echo $row_rs_service['title1']; ?></td>
                                                    ...
                                                    <td style="vertical-align:middle;" align="center" class="nodarg">
                                                        ...
                                                        <a alt="Gallery" title="Gallery" href="../service_gallery/index.php?id=<?php echo $row_rs_index['id']; ?>" class="btn btn-outline btn-sm dark"> <i class="fa fa-image"></i></a>
