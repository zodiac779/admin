...
$query_rs_insert = sprintf("SELECT * FROM clients_logo WHERE id = %s", GetSQLValueString($colname_rs_insert, "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "clients_logo")) {
    ...
    if($checker1){
        ...
        mysql_select_db($database_conn_database, $conn_database);
        $query_rs_insert = "SELECT rank FROM clients_logo ORDER BY rank DESC LIMIT 1";
        $rs_insert = mysql_query($query_rs_insert, $conn_database) or die(mysql_error());
        $row_rs_insert = mysql_fetch_assoc($rs_insert);

        $new_rank = $row_rs_insert['rank']+1;

        $insertSQL = sprintf("INSERT INTO clients_logo (image1, alt1, status, rank) VALUES (%s, %s, %s, %s)",
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase">Client Logo Insert</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            <?php if(isset($uploadMessage1)){?>
                                <div class="alert alert-block alert-danger fade in">
                                    <button type="button" class="close" data-dismiss="alert"></button>
                                    <h4 class="alert-heading" style="margin-bottom:0px"><?php echo '>Client Logo'.$uploadMessage1; ?></h4>
                                </div>
                            <?php } ?> 
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="clients_logo" id="clients_logo" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <label>Client Logo Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 400 x 300 px</span> <span style="font-size:14px; color:#F00;">*</span>
                                                                <div class="input-group ">
                                                                    ...
                                                                    <input type="file" name="image1" id="image1" require onchange="imageSelectHandler(this);" data-width="400" data-height="300">
                                                                    </span>
                                    ...
                                    <input type="hidden" name="MM_insert" value="clients_logo">
                                </form>
                                <script>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            $('#clients_logo').on('submit', function(){
                var reposn = true;
                $('#clients_logo').find('input[require]').each(function(){
                    if($(this).val() == ""){
