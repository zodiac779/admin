...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "content")) {
    ...
    $savefolder = '../../images/testimonial/';                          // folder for upload
    $checker1 = true;
    ...
    if($checker1){
        ...
        $updateSQL = sprintf("UPDATE content SET image1 = %s, alt1 = %s, lastupdate = now() WHERE id = %s",
...
$query_rs_update = "SELECT * FROM content WHERE id = 8";
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject  uppercase">Testimonial Image Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Testimonial Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 2,000 x 1,500 px</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" onchange="imageSelectHandler(this);" data-width="2000" data-height="1500">
                                                                            </span>
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/testimonial/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button delete_image_3" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Alternative Text Testimonial Image</label>
