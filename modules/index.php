...
$rs_modules = mysql_query($query_rs_modules, $conn_database) or die(mysql_error());
$row_rs_modules = mysql_fetch_assoc($rs_modules);
$totalRows_rs_modules = mysql_num_rows($rs_modules);
