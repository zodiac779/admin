...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "team")) {
    ...
    if($checker1){
        ...
        $updateSQL = sprintf("UPDATE team SET image1 = %s, alt1 = %s, facebook = %s, twitter = %s, instagram = %s, status = %s, lastupdate = now() WHERE id = %s",
        ...
        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
            $updateSQL = sprintf("UPDATE team_localization SET title1 = %s, title2 = %s WHERE team_id = %s AND lang_id = %s",
...
$query_rs_update = sprintf("SELECT * FROM team WHERE id = %s", GetSQLValueString($colname_rs_update, "int"));
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase">Team Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="team" id="team" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="light">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Team Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 450 x 550 px</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" onchange="imageSelectHandler(this);" data-width="450" data-height="550">
                                                                            </span>
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/teams/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button delete_image_3" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">                                                
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="facebook" id="facebook" class="form-control" placeholder="" value="<?php echo $row_rs_update['facebook']; ?>">
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">                                                
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="twitter" id="twitter" class="form-control" placeholder="" value="<?php echo $row_rs_update['twitter']; ?>">
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">                                                
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="instagram" id="instagram" class="form-control" placeholder="" value="<?php echo $row_rs_update['instagram']; ?>">
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        $query_rs_team = sprintf("SELECT * FROM team_localization tl WHERE tl.lang_id = %d AND tl.team_id = %d", GetSQLValueString($row_rs_lang['id'],'int'), GetSQLValueString($row_rs_update['id'],'int'));
                                                        $rs_team = mysqli_query(conn_database(),$query_rs_team) or die(mysql_error());
                                                        $row_rs_team = mysqli_fetch_assoc($rs_team);
                                                        $totalRows_rs_team = mysqli_num_rows($rs_team);
                                                        if($totalRows_rs_team==0){
                                                          
                                                          $query_add_team = sprintf("INSERT INTO team_localization(lang_id, team_id) VALUES (%d, %d)",
                                                          GetSQLValueString($row_rs_lang['id'],'int'),GetSQLValueString($row_rs_update['id'],'int'));
                                                          mysqli_query(conn_database(),$query_add_team) or die(mysql_error());
                                                        }
                                                        $counter++;
                                                        } while ($totalRows_rs_team==0 and $counter <= 1) ?>
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_team['title1']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Team Position Title</label>
                                                                <input type="text" name="title2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_team['title2']; ?>"> 
                                                            </div>
                                                        </div>
                                    ...
                                    <input type="hidden" name="MM_update" value="team">
                                </form>
                                <script>
