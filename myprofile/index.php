...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  ...
  $rs_current_pw = mysql_query($query_rs_current_pw, $conn_database) or die(mysql_error());
  $row_rs_current_pw = mysql_fetch_assoc($rs_current_pw);
  $totalRows_rs_current_pw = mysql_num_rows($rs_current_pw);
  ...
  mysql_free_result($rs_current_pw);
}
