...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "content")) {
    ...
    $updateSQL = sprintf("UPDATE content SET meta_title = %s, meta_keywords = %s, meta_description = %s, lastupdate = now() WHERE id = %s",
    ...
    while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
        $updateSQL = sprintf("UPDATE content_localization SET title1 = %s, title2 = %s, title3 = %s, title4 = %s, title5 = %s, title6 = %s, detail1 = %s, detail2 = %s, detail3 = %s, detail4 = %s WHERE content_id = %d AND lang_id = %d",
                        ...
                        GetSQLValueString($_POST['title5_'.strtolower($row_rs_lang['lang_abbr'])],'text'),
                        GetSQLValueString($_POST['title6_'.strtolower($row_rs_lang['lang_abbr'])],'text'),
                        ...
                        GetSQLValueString($_POST['detail3_'.strtolower($row_rs_lang['lang_abbr'])],'text'),
                        GetSQLValueString($_POST['detail4_'.strtolower($row_rs_lang['lang_abbr'])],'text'),
                        GetSQLValueString($_POST['id'], "int"),
        ...
        $updateSQL = sprintf("UPDATE setting SET latitude = %s, longitude = %s, website = %s, phone = %s, email = %s, lastupdate = now() WHERE id = %s",
...
$query_rs_update = "SELECT * FROM content WHERE id = 7";
...
<html lang="en">
    ...
    <head>
        ...
        <script src="//maps.google.com/maps/api/js?key=AIzaSyC1jJD77MZNqvFn0PT7JHYY_rcu2W_tA7I" type="text/javascript"></script>
    </head>
    <!-- END HEAD -->
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject  uppercase">Content Contact Us Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">                                                
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="phone" id="phone" class="form-control" placeholder="" value="<?php echo $row_rs_setting['phone']; ?>"> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="email" id="email" class="form-control" placeholder="" value="<?php echo $row_rs_setting['email']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                                                            <input type="text" name="latitude" id="latitude" class="form-control" placeholder="" value="<?php echo $row_rs_setting['latitude']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                                                            <input type="text" name="longitude" id="longitude" class="form-control" placeholder="" value="<?php echo $row_rs_setting['longitude']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Contact Headquarters Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Contact Company Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title5_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title5_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_content['title5']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Contact Button Title</label>
                                                                <input type="text" name="title6_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title6_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_content['title6']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Contact Detail</label>
                                                                <textarea class="form-control ckeditor" name="detail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="detail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" cols="45" rows="5"><?php echo $row_rs_content['detail1']; ?></textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Contact Right Detail</label>
                                                                <textarea class="form-control ckeditor" name="detail2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="detail2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" cols="45" rows="5"><?php echo $row_rs_content['detail2']; ?></textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Address</label>
                                                                <textarea class="form-control ckeditor" name="detail3_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="detail3_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" cols="45" rows="5"><?php echo $row_rs_content['detail3']; ?></textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Contact Bottom Title</label>
                                                                <input type="text" name="detail4_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="detail4_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_content['detail4']; ?>">
                                                            </div>
...
<![endif]-->
        ...
        var map = new google.maps.Map(document.getElementById('map_canvas'), {
            zoom: 16,
            center: new google.maps.LatLng(<?php echo $row_rs_setting['latitude']; ?>, <?php echo $row_rs_setting['longitude']; ?>),
            mapTypeId: google.maps.MapTypeId.ROADMAP
        });

        var myMarker = new google.maps.Marker({
            position: new google.maps.LatLng(<?php echo $row_rs_setting['latitude']; ?>, <?php echo $row_rs_setting['longitude']; ?>),
            draggable: true
        });

        google.maps.event.addListener(myMarker, 'dragend', function (evt) {
            //document.getElementById('current').innerHTML = '<p>Marker dropped: Current Lat: ' + evt.latLng.lat().toFixed(3) + ' Current Lng: ' + evt.latLng.lng().toFixed(3) + '</p>';
            latitude.value = evt.latLng.lat().toFixed(8);
            longitude.value = evt.latLng.lng().toFixed(8);
        });
