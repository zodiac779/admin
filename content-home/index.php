...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "content")) {
    ...
    $allowtype2 = array('webm');      // allowed file extension
    $allowtype3 = array('mp4');      // allowed file extension
    $max_size = 10000000;                                               // max file size 10MB
    $savefolder1 = '../../images/videos/images/';                              // folder for upload
    $savefolder2 = '../../images/videos/';                               // folder for upload
    $checker1 = true;
    $checker2 = true;
    $checker3 = true;
    ...
    if(isset($_FILES["video_webm"]) and $_FILES["video_webm"]["name"]!= "")
    {
        $value1= $_FILES['video_webm']['name'];
        $value2 = explode(".", strtolower($value1));
        $type = end($value2);
        if (in_array($type, $allowtype2)){
            if ($_FILES['video_webm']['size'] <= $max_size){
                copy($_FILES["video_webm"]["tmp_name"],$savefolder2.$_FILES["video_webm"]["name"]);
                $filename2 = $_FILES["video_webm"]["name"];
                if(!$filename2){
    ...
    if(isset($_FILES["video_mp4"]) and $_FILES["video_mp4"]["name"]!= "")
    {
        $value1= $_FILES['video_mp4']['name'];
        $value2 = explode(".", strtolower($value1));
        $type = end($value2);
        if (in_array($type, $allowtype3)){
            if ($_FILES['video_mp4']['size'] <= $max_size){
                copy($_FILES["video_mp4"]["tmp_name"],$savefolder2.$_FILES["video_mp4"]["name"]);
                $filename3 = $_FILES["video_mp4"]["name"];
                if(!$filename3){
                    $uploadMessage2 = "cannot be uploaded.";
                    $filename3 = $_POST['existing_file_3'];
                    $checker3 = false;
                }
            }else{
                $uploadMessage2 = "cannot be uploaded. (Your file is too large.)";
    ...
    if($checker1 && $checker2 && $checker3){
        ...
        $updateSQL = sprintf("UPDATE content SET meta_title = %s, meta_keywords = %s, meta_description = %s, image1 = %s, video_webm = %s, video_mp4 = %s, text_color = %s, button_color = %s, button_link = %s, lastupdate = now() WHERE id = %s",
                           ...
                           GetSQLValueString($_POST['text_color'], "text"),
                           GetSQLValueString($_POST['button_color'], "text"),
                           GetSQLValueString($_POST['button_link'], "text"),
        ...
        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
            $updateSQL = sprintf("UPDATE content_localization SET title1 = %s, title2 = %s WHERE content_id = %d AND lang_id = %d",
...
$query_rs_update = "SELECT * FROM content WHERE id = 1";
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject  uppercase">Content Home Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                                ...
                                <form action="<?php echo $editFormAction; ?>" name="content" id="content" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <?php if(isset($uploadMessage1)){?>
                                                        <div class="alert alert-block alert-danger fade in">
                                                            <button type="button" class="close" data-dismiss="alert"></button>
                                                            <h4 class="alert-heading" style="margin-bottom:0px"><?php echo 'Video Image'.$uploadMessage1; ?></h4>
                                                        </div>
                                                    <?php } ?>
                                                    ...
                                                    <?php if(isset($uploadMessage2)){?>
                                                        <div class="alert alert-block alert-danger fade in">
                                                            <button type="button" class="close" data-dismiss="alert"></button>
                                                            <h4 class="alert-heading" style="margin-bottom:0px"><?php echo 'Video File'.$uploadMessage2; ?></h4>
                                                        </div>
                                                    <?php } ?>
                                                    ...
                                                    <?php if(isset($uploadMessage3)){?>
                                                        <div class="alert alert-block alert-danger fade in">
                                                            <button type="button" class="close" data-dismiss="alert"></button>
                                                            <h4 class="alert-heading" style="margin-bottom:0px"><?php echo 'Video File'.$uploadMessage3; ?></h4>
                                                        </div>
                                                    <?php } ?>                                                     
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade <?php if(!isset($_POST["current_tab"]) || $_POST["current_tab"] == "tab_1_1"){echo 'active in';}?>" id="tab_1_1">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Video Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 1,920 x 1,080 px</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" onchange="imageSelectHandler(this);" data-width="1920" data-height="1080">
                                                                            </span>
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/videos/images/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button delete_image_3" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">                                                
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="text_color" id="text_color" class="form-control demo" placeholder="" value="<?php echo $row_rs_update['text_color']; ?>"> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Video File</label> <span style="font-size:11px; color:#0070c0;">Type : webm</span>
                                                                        <div class="input-group ">
                                                                            <div class="form-control uneditable-input span3" data-trigger="fileinput">
                                                                                <i class="fa fa-video-camera"></i>&nbsp; <span class="fileinput-filename"><?php echo $row_rs_update['video_webm']; ?></span>
                                                                            </div>
                                                                            <span class="input-group-addon btn default btn-file">
                                                                            <span class="fileinput-new">Select file </span>
                                                                            <span class="fileinput-exists">Change </span>
                                                                            ...
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['video_webm'] != ""){ ?><a href="../../images/videos/<?php echo $row_rs_update['video_webm']; ?>" class="input-group-addon btn blue fancybox-button" target="_blank"><i class="fa fa-video-camera" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">                                                
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"><i class="fa fa-eyedropper"></i></span>
                                                                            <input type="text" name="button_color" id="button_color" class="form-control demo" placeholder="" value="<?php echo $row_rs_update['button_color']; ?>"> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Video File</label> <span style="font-size:11px; color:#0070c0;">Type : mp4</span>
                                                                        <div class="input-group ">
                                                                            <div class="form-control uneditable-input span3" data-trigger="fileinput">
                                                                                <i class="fa fa-video-camera"></i>&nbsp; <span class="fileinput-filename"><?php echo $row_rs_update['video_mp4']; ?></span>
                                                                            </div>
                                                                            <span class="input-group-addon btn default btn-file">
                                                                            <span class="fileinput-new">Select file </span>
                                                                            <span class="fileinput-exists">Change </span>
                                                                            ...
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['video_mp4'] != ""){ ?><a href="../../images/videos/<?php echo $row_rs_update['video_mp4']; ?>" class="input-group-addon btn blue fancybox-button" target="_blank"><i class="fa fa-video-camera" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="button_link" id="button_link" class="form-control" placeholder="" onChange="javascript:this.value=this.value.toLowerCase();" value="<?php echo $row_rs_update['button_link']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        $rs_content = mysqli_query(conn_database(),$query_rs_content) or die(mysql_error());
                                                        $row_rs_content = mysqli_fetch_assoc($rs_content);
                                                        $totalRows_rs_content = mysqli_num_rows($rs_content);
                                                        if($totalRows_rs_content==0){
                                                          ...
                                                          mysqli_query(conn_database(),$query_add_content) or die(mysql_error());
                                                        }
                                                        $counter++;
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" data-role="tagsinput" class="form-control" placeholder="" value="<?php echo $row_rs_content['title1']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>View Button Title</label>
                                    ...
                                    <div class="form-actions right">
                                      ...
                                      <input name="id" type="hidden" value="<?php echo $row_rs_update['id']; ?>">
                                          ...
                                          <input name="existing_file_2" id="existing_file_2" type="hidden" value="<?php echo $row_rs_update['video_webm']; ?>">
                                          <input name="existing_file_3" id="existing_file_3" type="hidden" value="<?php echo $row_rs_update['video_mp4']; ?>">
