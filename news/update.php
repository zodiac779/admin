...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "news_events")) {
    ...
    if($checker1 && $checker2){
        ...
        $updateSQL = sprintf("UPDATE news_events SET meta_title = %s, meta_keywords = %s, meta_description = %s, meta_slug = %s, date = %s, image1 = %s, image2 = %s, alt1 = %s, alt2 = %s, showhome = %s, related = %s, status = %s, lastupdate = now() WHERE id = %s",
        ...
        while ($row_rs_lang = mysql_fetch_assoc($rs_lang)){
            $updateSQL = sprintf("UPDATE news_events_localization SET title1 = %s, shortdetail1 = %s, detail1 = %s WHERE news_events_id = %s AND lang_id = %s",
...
mysql_select_db($database_conn_database, $conn_database);
$query_rs_update = sprintf("SELECT * FROM news_events WHERE id = %s", GetSQLValueString($colname_rs_update, "int"));
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase">News & Events Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="news_events" id="news_events" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    <?php if(isset($Result1)){ ?>
                                                        <div class="alert alert-block alert-success fade in">
                                                            ...
                                                            <h4 class="alert-heading" style="margin-bottom:0px">Your news & events has been updated.</h4>
                                                        </div>
                                                    <?php } ?>
                                                    ...
                                                    <?php if(isset($uploadMessage1)){?>
                                                        <div class="alert alert-block alert-danger fade in">
                                                            <button type="button" class="close" data-dismiss="alert"></button>
                                                            <h4 class="alert-heading" style="margin-bottom:0px"><?php echo 'News & Events Image'.$uploadMessage1; ?></h4>
                                                        </div>
                                                    <?php } ?>                                                  
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>News & Events Thumbnail</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 500 x 280 px</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" onchange="imageSelectHandler(this);" data-width="500" data-height="280">
                                                                            </span>
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/blog/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        ...
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image2'] != ""){ ?><a href="../../images/blog_detail/<?php echo $row_rs_update['image2']; ?>" class="input-group-addon btn blue fancybox-button delete_image_2" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><a href="javascript:deleteIMG(2)" class="input-group-addon btn red fancybox-button delete_image_2"><i class="fa fa-times" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group input-medium date date-picker" data-date="<?php echo date('d/m/Y', strtotime($row_rs_update['date']));?>" data-date-format="dd/mm/yyyy" data-date-viewmode="years">
                                                                        <input type="text" class="form-control" readonly id="date_selector" name="date_selector" value="<?php echo date('d/m/Y', strtotime($row_rs_update['date']));?>">
                                                        ...
                                                        do {
                                                        mysql_select_db($database_conn_database, $conn_database);
                                                        $query_rs_news_events = sprintf("SELECT * FROM news_events_localization tl WHERE tl.lang_id = %d AND tl.news_events_id = %d", GetSQLValueString($row_rs_lang['id'],'int'), GetSQLValueString($row_rs_update['id'],'int'));
                                                        $rs_news_events = mysql_query($query_rs_news_events, $conn_database) or die(mysql_error());
                                                        $row_rs_news_events = mysql_fetch_assoc($rs_news_events);
                                                        $totalRows_rs_news_events = mysql_num_rows($rs_news_events);
                                                        if($totalRows_rs_news_events==0){
                                                          mysql_select_db($database_conn_database, $conn_database);
                                                          $query_add_news_events = sprintf("INSERT INTO news_events_localization(lang_id, news_events_id) VALUES (%d, %d)",
                                                          GetSQLValueString($row_rs_lang['id'],'int'),GetSQLValueString($row_rs_update['id'],'int'));
                                                          mysql_query($query_add_news_events, $conn_database) or die(mysql_error());
                                                        }
                                                        $counter++;
                                                        } while ($totalRows_rs_news_events==0 and $counter <= 1) ?>
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_news_events['title1']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>News & Events Shortdetail</label>
                                                                <textarea class="form-control ckeditor" name="shortdetail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="shortdetail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" cols="45" rows="5"><?php echo $row_rs_news_events['shortdetail1']; ?></textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>News & Events Detail</label>
                                                                <textarea class="form-control ckeditor" name="detail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="detail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" cols="45" rows="5"><?php echo $row_rs_news_events['detail1']; ?></textarea>
                                                            </div>
                                    ...
                                    <input type="hidden" name="MM_update" value="news_events">
                                </form>
                                <script>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            function checkSlug(evnt){
                ...
                type: 'POST',
                url: '../checkSlug.php',
                data: {tableName:'news_events',dataValue:$('#meta_slug').prop('value'),cID:'<?php echo $row_rs_update['id'];?>'},
