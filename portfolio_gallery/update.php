...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "portfolio_gallery")) {
    ...
    if($checker1){
        ...
        $updateSQL = sprintf("UPDATE portfolio_gallery SET image1 = %s, alt1 = %s, status = %s, lastupdate = now() WHERE id = %s",
...
$query_rs_update = sprintf("SELECT * FROM portfolio_gallery WHERE id = %s", GetSQLValueString($colname_rs_update, "int"));
...
$colname_rs_portfolio = "-1";
if (isset($_GET['portfolio_id'])) {
  $colname_rs_portfolio = $_GET['portfolio_id'];
}

$query_rs_portfolio = sprintf("SELECT * FROM portfolio_localization INNER JOIN languages ON languages.id = portfolio_localization.lang_id WHERE portfolio_id  = %d ORDER BY languages.rank DESC LIMIT 1", GetSQLValueString($colname_rs_portfolio, "int"));
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase"><?php echo $row_rs_portfolio['title1']; ?>'s Gallery Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                            ...
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="portfolio_gallery" id="portfolio_gallery" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    <?php if(isset($Result1)){ ?>
                                                        <div class="alert alert-block alert-success fade in">
                                                            ...
                                                            <h4 class="alert-heading" style="margin-bottom:0px">Your portfolio gallery has been updated.</h4>
                                                        </div>
                                                    <?php } ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    <label>Portfolio Gallery Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 600 x 450 px</span>
                                                                    <div class="input-group ">
                                                                        ...
                                                                        <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/portfolios/gallery/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Alternative Text Portfolio Gallery Image</label>
                                    ...
                                    <div class="form-actions right">
                                      ...
                                      <a href="index.php?id=<?php echo $row_rs_update['portfolio_id']; ?>" class="btn dark btn-outline" >Back</a>
                                    ...
                                    <input type="hidden" name="MM_update" value="portfolio_gallery">
                                </form>
                                <script>
