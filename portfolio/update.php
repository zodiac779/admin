                                            ...
                                            <div class="light">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        $rs_portfolio = mysql_query($query_rs_portfolio, $conn_database) or die(mysql_error());
                                                        $row_rs_portfolio = mysql_fetch_assoc($rs_portfolio);
                                                        $totalRows_rs_portfolio = mysql_num_rows($rs_portfolio);
                                                        if($totalRows_rs_portfolio==0){
                                                          ...
                                                          mysql_query($query_add_portfolio, $conn_database) or die(mysql_error());
                                                        }
                                                        $counter++;
