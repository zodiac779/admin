...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "portfolio")) {
    ...
    if($checker1){
        ...
        $updateSQL = sprintf("UPDATE portfolio SET meta_title = %s, meta_keywords = %s, meta_description = %s, meta_slug = %s, image1 = %s, alt1 = %s, image_size = %s, portfolio_date = %s, client_website = %s, showhome = %s, recommend = %s, status = %s, lastupdate = now() WHERE id = %s",
        ...
        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
            $updateSQL = sprintf("UPDATE portfolio_localization SET title1 = %s, title2 = %s, title3 = %s, title4 = %s, detail1 = %s, detail2 = %s WHERE portfolio_id = %s AND lang_id = %s",
...
$query_rs_update = sprintf("SELECT * FROM portfolio WHERE id = %s", GetSQLValueString($colname_rs_update, "int"));
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase">Portfolio Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="portfolio" id="portfolio" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    <?php if(isset($Result1)){ ?>
                                                        <div class="alert alert-block alert-success fade in">
                                                            ...
                                                            <h4 class="alert-heading" style="margin-bottom:0px">Your Portfolio has been updated.</h4>
                                                        </div>
                                                    <?php } ?>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade <?php if(!isset($_POST["current_tab"]) || $_POST["current_tab"] == "tab_1_1"){echo 'active in';}?>" id="tab_1_1">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Portfolio Image Size</label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"><i class="fa fa-file-image-o"></i></span>
                                                                            <select name="image_size" id="image_size" class="form-control">
                                                                            <option <?php if($row_rs_update['image_size'] == 'wide large') echo 'selected = "selected"' ; ?> value="wide large">Large</option>
                                                                                <option <?php if($row_rs_update['image_size'] == 'wide medium') echo 'selected = "selected"' ; ?> value="wide medium">Medium</option>
                                                                                <option <?php if($row_rs_update['image_size'] == 'small') echo 'selected = "selected"' ; ?> value="small">Small</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group input-medium date date-picker" data-date="<?php echo date('d/m/Y', strtotime($row_rs_update['portfolio_date'])); ?>" data-date-format="dd/mm/yyyy" data-date-viewmode="years">
                                                                            <input type="text" class="form-control" readonly id="portfolio_date" name="portfolio_date" value="<?php echo date('d/m/Y', strtotime($row_rs_update['portfolio_date']));?>">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6" id="div_image">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Portfolio Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 800 x 600 px</span> 
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/portfolios/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">                                                
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="client_website" id="client_website" class="form-control" placeholder="" value="<?php echo $row_rs_update['client_website']; ?>"> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="bootstrap-switch-container">
                                                                        <input type="checkbox" name="recommend" id="recommend" <?php if (!(strcmp(1, $row_rs_update['recommend']))) {echo "checked";} ?> class="make-switch" data-size="normal" data-on-text="<i class='fa fa-check'></i>" data-off-text="<i class='fa fa-times'></i>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                        ...
                                                        $query_rs_portfolio = sprintf("SELECT * FROM portfolio_localization tl WHERE tl.lang_id = %d AND tl.portfolio_id = %d", GetSQLValueString($row_rs_lang['id'],'int'), GetSQLValueString($row_rs_update['id'],'int'));
                                                        $rs_portfolio = mysqli_query(conn_database(),$query_rs_portfolio) or die(mysql_error());
                                                        $row_rs_portfolio = mysqli_fetch_assoc($rs_portfolio);
                                                        $totalRows_rs_portfolio = mysqli_num_rows($rs_portfolio);
                                                        if($totalRows_rs_portfolio==0){
                                                          
                                                          $query_add_portfolio = sprintf("INSERT INTO portfolio_localization(lang_id, portfolio_id) VALUES (%d, %d)",
                                                          GetSQLValueString($row_rs_lang['id'],'int'),GetSQLValueString($row_rs_update['id'],'int'));
                                                          mysqli_query(conn_database(),$query_add_portfolio) or die(mysql_error());
                                                        }
                                                        $counter++;
                                                        } while ($totalRows_rs_portfolio==0 and $counter <= 1) ?>
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" require class="form-control" placeholder="" value="<?php echo $row_rs_portfolio['title1']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Portfolio Subtitle</label>
                                                                <input type="text" name="title2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_portfolio['title2']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Portfolio Created by</label>
                                                                <input type="text" name="title3_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title3_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_portfolio['title3']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Portfolio Client</label>
                                                                <input type="text" name="title4_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title4_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_portfolio['title4']; ?>"> 
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Portfolio Left Detail</label>
                                                                <textarea class="form-control ckeditor" name="detail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="detail1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" cols="45" rows="5"><?php echo $row_rs_portfolio['detail1']; ?></textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Portfolio Right Detail</label>
                                                                <textarea class="form-control ckeditor" name="detail2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="detail2_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" cols="45" rows="5"><?php echo $row_rs_portfolio['detail2']; ?></textarea>
                                                            </div>
                                    ...
                                    <input type="hidden" name="MM_update" value="portfolio">
                                </form>
                                <script>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            function checkSlug(evnt){
                ...
                type: 'POST',
                url: '../checkSlug.php',
                data: {tableName:'portfolio',dataValue:$('#meta_slug').prop('value'),cID:'<?php echo  $row_rs_update['id'];?>'},
