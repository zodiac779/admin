                                            ...
                                            <div class="light">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        $rs_product_gallery = mysqli_query(conn_database(),$query_rs_product_gallery) or die(mysql_error());
                                                        $row_rs_product_gallery = mysqli_fetch_assoc($rs_product_gallery);
                                                        $totalRows_rs_product_gallery = mysqli_num_rows($rs_product_gallery);
                                                        if($totalRows_rs_product_gallery==0){
                                                          ...
                                                          mysqli_query(conn_database(),$query_add_product_gallery) or die(mysql_error());
                                                        }
                                                        $counter++;
