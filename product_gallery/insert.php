...
$query_rs_insert = sprintf("SELECT * FROM product_localization INNER JOIN languages ON languages.id = product_localization.lang_id WHERE product_id  = %d ORDER BY languages.rank DESC LIMIT 1", GetSQLValueString($colname_rs_insert, "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "product_gallery")) {
    ...
    if($checker1){
        ...
        $query_rs_insert = "SELECT rank FROM product_gallery WHERE product_id = ".$_POST['product_id']." ORDER BY rank DESC LIMIT 1";
        $rs_insert = mysqli_query(conn_database(),$query_rs_insert) or die(mysql_error());
        $row_rs_insert = mysqli_fetch_assoc($rs_insert);

        $new_rank = $row_rs_insert['rank']+1;

        $insertSQL = sprintf("INSERT INTO product_gallery (product_id, image1, alt1, status, rank) VALUES (%s, %s, %s, %s, %s)",
        ...
        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
            $insertSQL = sprintf("INSERT INTO product_gallery_localization (title1, product_gallery_id, lang_id) VALUES(%s, %d, %d) ",
        ...
        if(isset($_POST['insert_more']))
            $insertGoTo = "insert.php?id=".$colname_rs_insert['product_id'];
        else
                            ...
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="product_gallery" id="product_gallery" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Product Gallery Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 600 x 450 px</span> <span style="font-size:14px; color:#F00;">*</span>
                                                        ...
                                                        <div class="tab-pane fade" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Product Gallery Title</label> <span style="font-size:14px; color:#F00;">*</span>
                                    ...
                                    <div class="form-actions right">
                                        <a href="index.php?id=<?php echo $row_rs_insert['product_id']; ?>" class="btn btn-outline dark" >Back</a>
                                    ...
                                    <input type="hidden" name="MM_insert" value="product_gallery">
                                    <input type="hidden" name="product_id" value="<?php echo $colname_rs_insert; ?>">
                                </form>
                                <script>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            $('#product_gallery').on('submit', function(){
                var reposn = true;
                $('#product_gallery').find('input[require]').each(function(){
                    if($(this).val() == ""){
