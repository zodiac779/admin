...
$query_rs_insert = sprintf("SELECT * FROM product WHERE id = %s", GetSQLValueString($colname_rs_insert, "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "product")) {
    ...
    if($checker1 && $checker2){
        ...
        $query_rs_insert = "SELECT rank FROM product ORDER BY rank DESC LIMIT 1";
        $rs_insert = mysqli_query(conn_database(),$query_rs_insert) or die(mysql_error());
        $row_rs_insert = mysqli_fetch_assoc($rs_insert);

        $new_rank = $row_rs_insert['rank']+1;

        $insertSQL = sprintf("INSERT INTO product (meta_title, meta_keywords, meta_description, meta_slug, image1, image2, alt1, alt2, showhome, related, status, rank) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
            $insertSQL = sprintf("INSERT INTO product_localization (title1, detail1, product_id, lang_id) VALUES(%s, %s, %d, %d) ",
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase">Product Insert</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            <?php if(isset($uploadMessage2)){?>
                                <div class="alert alert-block alert-danger fade in">
                                    <button type="button" class="close" data-dismiss="alert"></button>
                                    <h4 class="alert-heading" style="margin-bottom:0px"><?php echo 'Product Image (on mouse hover) '.$uploadMessage2; ?></h4>
                                </div>
                            <?php } ?>
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="product" id="product" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Product Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 600 x 450 px</span> <span style="font-size:14px; color:#F00;">*</span>
                                                        ...
                                                        <div class="tab-pane fade" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Product Title</label> <span style="font-size:14px; color:#F00;">*</span>
                                    ...
                                    <input type="hidden" name="MM_insert" value="product">
                                </form>
                                <script>
        ...
        <script type="text/javascript">
            ...
            function checkSlug(evnt){
                ...
                var resultCheck = $.ajax({
                    type: 'POST',
                    url: '../checkSlug.php',
                    data: {tableName:'product',dataValue:$('#meta_slug').prop('value'),cID:'0'},
            ...
            $('#product').on('submit', function(){
                var reposn = true;
                $('#product').find('input[require]').each(function(){
                    if($(this).val() == ""){
