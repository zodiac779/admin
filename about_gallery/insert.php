...
mysql_select_db($database_conn_database, $conn_database);
$query_rs_insert = sprintf("SELECT * FROM about_gallery WHERE id = %s", GetSQLValueString($colname_rs_insert, "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "about_gallery")) {
    ...
    if($checker1){
        ...
        mysql_select_db($database_conn_database, $conn_database);
        $query_rs_insert = "SELECT rank FROM about_gallery WHERE content_id = 2 ORDER BY rank DESC LIMIT 1";
        $rs_insert = mysql_query($query_rs_insert, $conn_database) or die(mysql_error());
        $row_rs_insert = mysql_fetch_assoc($rs_insert);

        $new_rank = $row_rs_insert['rank']+1;

        $insertSQL = sprintf("INSERT INTO about_gallery (content_id, image1, alt1, text_position, status, rank) VALUES (%s, %s, %s, %s, %s, %s)",
        ...
        $about_gallery_id = mysql_insert_id();

        mysql_data_seek($rs_lang, 0);
        while ($row_rs_lang = mysql_fetch_assoc($rs_lang)){
            $insertSQL = sprintf("INSERT INTO about_gallery_localization (title1, about_gallery_id, lang_id) VALUES(%s, %d, %d) ",
                            GetSQLValueString($_POST['title1_'.strtolower($row_rs_lang['lang_abbr'])],'text'),
                            GetSQLValueString($about_gallery_id, "int"),
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase">About Us Gallery Insert</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <?php if(isset($Result1)){ ?>
                                <div class="alert alert-block alert-success fade in">
                                    ...
                                    <h4 class="alert-heading" style="margin-bottom:0px">Your about us gallery has been updated.</h4>
                                </div>
                            <?php } ?>
                            ...
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="about_gallery" id="about_gallery" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="light">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>About Us Gallery Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 1,140 x 500 px</span> <span style="font-size:14px; color:#F00;">*</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" require onchange="imageSelectHandler(this);" data-width="1140" data-height="500">
                                                                            </span>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <select name="text_position" id="text_position" class="form-control">
                                                                                ...
                                                                                <option value="slider-caption-bottom-right">Text Right</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="tab-pane fade" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>About Us Gallery Title</label> <span style="font-size:14px; color:#F00;">*</span>
                                    ...
                                    <input type="hidden" name="MM_insert" value="about_gallery">
                                </form>
                                <script>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            $('#about_gallery').on('submit', function(){
                var reposn = true;
                $('#about_gallery').find('input[require]').each(function(){
                    if($(this).val() == ""){
