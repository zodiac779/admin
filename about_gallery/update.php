                                            ...
                                            <div class="light">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        $rs_about_gallery = mysql_query($query_rs_about_gallery, $conn_database) or die(mysql_error());
                                                        $row_rs_about_gallery = mysql_fetch_assoc($rs_about_gallery);
                                                        $totalRows_rs_about_gallery = mysql_num_rows($rs_about_gallery);
                                                        if($totalRows_rs_about_gallery==0){
                                                          ...
                                                          mysql_query($query_add_about_gallery, $conn_database) or die(mysql_error());
                                                        }
                                                        $counter++;
