...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "about_gallery")) {
    ...
    if($checker1){
        ...
        $updateSQL = sprintf("UPDATE about_gallery SET image1 = %s, alt1 = %s, text_position = %s, status = %s, lastupdate = now() WHERE id = %s",
                            GetSQLValueString($filename1, "text"),
                            GetSQLValueString($_POST['alt1'], "text"),
                            GetSQLValueString($_POST['text_position'], "text"),
        ...
        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
            $updateSQL = sprintf("UPDATE about_gallery_localization SET title1 = %s WHERE about_gallery_id = %s AND lang_id = %s",
...
$query_rs_update = sprintf("SELECT * FROM about_gallery WHERE id = %s", GetSQLValueString($colname_rs_update, "int"));
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject uppercase">About Us Gallery Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <div class="form-body" style="padding-bottom: 0px;">
                                <form action="<?php echo $editFormAction; ?>" name="content" id="content" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <?php if(isset($uploadMessage1)){?>
                                                        <div class="alert alert-block alert-danger fade in">
                                                            <button type="button" class="close" data-dismiss="alert"></button>
                                                            <h4 class="alert-heading" style="margin-bottom:0px"><?php echo 'About Us Gallery'.$uploadMessage1; ?></h4>
                                                        </div>
                                                    <?php } ?>                                                  
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>About Us Gallery Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 1,140 x 500 px</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" onchange="imageSelectHandler(this);" data-width="1140" data-height="500">
                                                                            </span>
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/about/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button delete_image_3" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Alternative Text About Us Gallery Image</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <select name="text_position" id="text_position" class="form-control">
                                                                                <option <?php if($row_rs_update['text_position'] == '') echo 'selected = "selected"' ; ?> value="left">Text Left</option>
                                                                                <option <?php if($row_rs_update['text_position'] == 'slider-caption-bottom-right') echo 'selected = "selected"' ; ?> value="center">Text Right</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        $query_rs_about_gallery = sprintf("SELECT * FROM about_gallery_localization al WHERE al.lang_id = %d AND al.about_gallery_id = %d", GetSQLValueString($row_rs_lang['id'],'int'), GetSQLValueString($row_rs_update['id'],'int'));
                                                        $rs_about_gallery = mysqli_query(conn_database(),$query_rs_about_gallery) or die(mysql_error());
                                                        $row_rs_about_gallery = mysqli_fetch_assoc($rs_about_gallery);
                                                        $totalRows_rs_about_gallery = mysqli_num_rows($rs_about_gallery);
                                                        if($totalRows_rs_about_gallery==0){
                                                          
                                                          $query_add_about_gallery = sprintf("INSERT INTO about_gallery_localization(lang_id, about_gallery_id) VALUES (%d, %d)",
                                                          GetSQLValueString($row_rs_lang['id'],'int'),GetSQLValueString($row_rs_update['id'],'int'));
                                                          mysqli_query(conn_database(),$query_add_about_gallery) or die(mysql_error());
                                                        }
                                                        $counter++;
                                                        } while ($totalRows_rs_about_gallery==0 and $counter <= 1) ?>
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title1_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_about_gallery['title1']; ?>"> 
                                                            </div>
                                    ...
                                    <input type="hidden" name="MM_update" value="about_gallery">
                                </form>
                                <script>
