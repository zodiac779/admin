...
if(isset($_POST['data-id']) and isset($_POST['state'])){
    ...
    $query_rs_update = "UPDATE about_gallery SET `about_gallery`.`status` = ".$_POST['state']." WHERE `about_gallery`.`id` = ".$_POST['data-id'];
    $rs_update = mysql_query($query_rs_update, $conn_database) or die(mysql_error());
    exit();
}

mysql_select_db($database_conn_database, $conn_database);
$query_rs_index = "SELECT * FROM about_gallery ORDER BY rank DESC";
                                        ...
                                        <tbody>
                                            <?php if($totalRows_rs_index > 0){
                                                ...
                                                <tr data-id="<?php echo $row_rs_index['id']; ?>" data-rank="<?php echo $row_rs_index['rank']; ?>">
                                                    ...
                                                    <td style="vertical-align:middle;"><img src="../../images/about/<?php echo $row_rs_index['image1']; ?>" width="50" />&nbsp;</td>
                                                    ...
                                                    <td style="vertical-align:middle;" align="center" class="nodarg">
                                                        ...
                                                        <a alt="Edit" title="Edit" href="update.php?id=<?php echo $row_rs_index['id']; ?>&content_id=<?php echo $row_rs_index['content_id']; ?>" class="btn btn-outline btn-sm green"><i class="fa fa-edit"></i></a>
