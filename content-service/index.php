...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "content")) {
    ...
    $savefolder = '../../images/services/';                              // folder for upload
    $checker1 = true;
    ...
    if($checker1){
        ...
        $updateSQL = sprintf("UPDATE content SET meta_title = %s, meta_keywords = %s, meta_description = %s, image1 = %s, alt1 = %s, lastupdate = now() WHERE id = %s",
        ...
        while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
            $updateSQL = sprintf("UPDATE content_localization SET title1 = %s, title2 = %s, title3 = %s, title4 = %s, title5 = %s, detail1 = %s WHERE content_id = %d AND lang_id = %d",
...
$query_rs_update = "SELECT * FROM content WHERE id = 4";
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject  uppercase">Content Services Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <label>Service Image</label>&nbsp;&nbsp;<span style="font-size:11px; color:#0070c0;">Size : 1,024 x 1,024 px</span>
                                                                        <div class="input-group ">
                                                                            ...
                                                                            <input type="file" name="image1" id="image1" onchange="imageSelectHandler(this);" data-width="1024" data-height="1024">
                                                                            </span>
                                                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remove </a><?php if($row_rs_update['image1'] != ""){ ?><a href="../../images/services/<?php echo $row_rs_update['image1']; ?>" class="input-group-addon btn blue fancybox-button delete_image_3" target="_blank"><i class="icon-picture" style="color:#FFF;"></i></a><?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Alternative Text Service Image</label>
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Service Bottom Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Service View Button Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Service View Detail Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Related Services Title</label>
