...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "content")) {
    ...
    while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
        $updateSQL = sprintf("UPDATE content_localization SET title1 = %s, title2 = %s, title3 = %s, detail1 = %s, detail2 = %s WHERE content_id = %d AND lang_id = %d",
...
$query_rs_update = "SELECT * FROM content WHERE id = 2";
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject  uppercase">Content About Us Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>About Bottom Detail</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>About View Button Title</label>
