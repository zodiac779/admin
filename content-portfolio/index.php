...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "content")) {
    ...
    while ($row_rs_lang = mysqli_fetch_assoc($rs_lang)){
        $updateSQL = sprintf("UPDATE content_localization SET title1 = %s, title2 = %s, title3 = %s, title4 = %s, title5 = %s, title6 = %s, title7 = %s, detail1 = %s WHERE content_id = %d AND lang_id = %d",
                        ...
                        GetSQLValueString($_POST['title7_'.strtolower($row_rs_lang['lang_abbr'])],'text'),
...
$query_rs_update = "SELECT * FROM content WHERE id = 5";
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject  uppercase">Content Portfolio Update</span>
                            </div>
                            <div class="actions">
                            </div>
                        </div>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade <?php if(isset($_POST["current_tab"]) && $_POST["current_tab"] == "tab_1_".$row_rs_lang['lang_abbr']){echo 'active in';}?>" id="tab_1_<?php echo $row_rs_lang['lang_abbr']; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Portfolio View Button Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Portfolio Created By Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Portfolio Completed On Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Portfolio Client Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Portfolio Info Title</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Recommend Portfolio Title</label>
                                                                <input type="text" name="title7_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" id="title7_<?php echo strtolower($row_rs_lang['lang_abbr']); ?>" class="form-control" placeholder="" value="<?php echo $row_rs_content['title7']; ?>"> 
                                                            </div>
